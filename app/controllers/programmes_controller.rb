class ProgrammesController < ApplicationController
  ...
  private
    ...
    def programme_params
      params.require(:programme).permit(:name, :programme_type, :entrance, :self_finance, :intake, :indexing_rules, :ranking_priority, :general, :sc, :st, :muslim, :handicapped, :obc, :obh, :etb, :latin, :disabled)
    end
end
